...
TECH_NEWS_REQUIRED_TERMS = [
    ...
    # 以下為從 DORTS-EMDD/Weekly-report- repo（CORE_METRO_TECHNICAL_TERMS /
    # STRONG_TECHNICAL_DETAIL_TERMS）比對後，本檔案原本缺少的技術新知關鍵字。
    "railcar", "vehicle equipment", "depot equipment", "maintenance equipment", "ato",
    "atp", "ats", "operations control", "operation control", "control centre",
    "control center", "occ", "regenerative braking", "energy storage",
    "energy management", "wireless", "data transmission", "platform door",
    "station equipment", "hvac", "air conditioning", "ventilation", "fire system",
    "environmental control", "thermal energy network", "heat recovery",
    "platform cooling", "thermal management", "fault diagnosis",
    "predictive maintenance", "image recognition", "ai image", "system assurance",
    "rams", "safety verification", "interface management", "ot security",
    "ics security", "system testing", "technical verification", "light rail vehicle",
    "light rail vehicles", "LRV", "LRVs", "train cars", "two-car sets", "two car sets",
    "car sets", "automated metro", "automated metros", "line modernization",
    "line modernisation", "metro modernization", "metro modernisation",
    "modernization", "modernisation", "life cycle management",
    "life cycle management services", "fleet renewal", "fleet replacement", "overhaul",
    "power system", "automatic fare collection", "contactless payment", "tap to pay",
    ...
    "handheld inspection device", "payment system integration",
    "system interface problem", "ticketing outage", "rollout flaw",
    "passenger information system", "accessibility upgrade", "made accessible",
    "fire protection", "fire safety", "station systems", "fleet life-cycle management",
    ...
    "operations and maintenance center", "omc", "wheel lathe", "axle counter",
    "axle counters", "traction inverter", "traction inverters", "monitoring equipment",
    "電聯車", "車輛設備", "機廠設備", "維修設備", "列車控制", "行車監控", "行控中心", "牽引供電", "一般電力", "再生煞車",
    "儲能", "能源管理", "通訊系統", "無線通訊", "資料傳輸", "自動收費", "票務系統", "票閘", "車站機電", "空調", "通風",
    "消防", "環境控制", "電扶梯", "電梯", "無障礙機電", "狀態監測", "故障診斷", "預測性維護", "故障預測", "設備故障預測",
    "智慧維修", "自動巡檢", "影像辨識", "系統保證", "安全驗證", "介面管理", "工控資安", "系統測試", "技術驗證", "投入營運",
    "維修監測",
]
